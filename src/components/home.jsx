...
import bgHome3 from "../image/bg_home_1.jpg"; // Using for second section
...
function Home() {
  return (
    <div className="w-full">
      ...
      {/* Section 2 - Scrollable Content over Fixed Background */}
      <section
        className="min-h-screen flex flex-col justify-center items-center bg-center bg-cover px-6 sm:px-10 lg:px-20"
        style={{ backgroundImage: `url(${bgHome3})`, backgroundAttachment: "fixed" }}
      >
        <motion.div
